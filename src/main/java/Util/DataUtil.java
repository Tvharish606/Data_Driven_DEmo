...
public class DataUtil {
	...
	public static Object[][] getTestData(My_Xls_reader xls_received, String testName, String sheetName) throws Exception{
		
		My_Xls_reader xls = xls_received;
	...
	public static boolean isRunnable(My_Xls_reader xls_received, String tName, String sheet){
